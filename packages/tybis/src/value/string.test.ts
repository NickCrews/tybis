...
describe('String Operations', () => {
    describe('upper', () => {
        it('should preserve shape from operand', () => {
            ...
            expect(op.dtype()).toEqual({ typecode: 'string', nullable: true })
            expectTypeOf(op.dshape()).toEqualTypeOf<'columnar'>()
            expectTypeOf(op.dtype()).toEqualTypeOf<{ typecode: 'string', nullable: boolean }>()
        })
    ...
    describe('contains', () => {
        ...
        it('should work with a non-literal pattern', () => {
            ...
            expect(op.dtype()).toEqual({ typecode: 'boolean', nullable: true })
            expectTypeOf(op.dshape()).toEqualTypeOf<'columnar'>()
            expectTypeOf(op.dtype()).toEqualTypeOf<{ typecode: 'boolean', nullable: boolean }>()
        })
    })
